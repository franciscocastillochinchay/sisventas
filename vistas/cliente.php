...
<div class="panel-body" style="height: 400px;" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">yyyy Departamento(*):</label>
      <select name="iddepartamento" id="iddepartamento" class="form-control selectpicker" data-Live-search="true" required></select>
    </div>

    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Zona</label>
      <input class="form-control" type="text" name="zona" id="zona" maxlength="50" placeholder="Zona">
    </div>
